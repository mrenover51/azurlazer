...
export default function ZonePage() {
  return <>
    <PageHero eyebrow="Fréjus · Var · Région PACA" title="Zone d’intervention" subtitle="Basés à Fréjus, nous intervenons principalement dans un rayon d’environ 100 km et étudions certains projets plus largement en région PACA selon leur nature." />
    <section className="content-section"><div className="shell zone-grid">
      ...
      <div><SectionTitle eyebrow="Secteur habituel" title="Au départ de Fréjus" /><p className="body-large">Nous nous déplaçons dans le Var et dans une partie des Alpes-Maritimes pour vos projets de décapage laser et d’aérogommage. Selon leur nature, certains projets peuvent être étudiés plus largement en région PACA.</p><dl className="zone-data"><div><dt>Base</dt><dd>{company.intervention.departureCity}</dd></div><div><dt>Département</dt><dd>{company.intervention.department}</dd></div><div><dt>Rayon habituel</dt><dd>{company.intervention.radius}</dd></div></dl></div>
    </div></section>
